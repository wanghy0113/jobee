prompt = {
    ...
    {{
        "salary": // Optional salary range extracted from the job description, should be a list of two integers
        ...
        "company": // Optional company name extracted from the job description
    ...
    "examples": [
        (
            ...
            """
{{
    "salary": [120112, 166694],
    "locations": ["San Francisco, CA", "Los Angeles, CA"],
    "title": "Backend Software Engineer",
    "skills": ["Software testing", "Golang", "OpenAPI", "SAML", "RBAC", "OAuth", "JWT", "Docker", "Kubernetes", "CI/CD", "observability"],
    ...
    "job_contents": [
        "Design, develop, and maintain robust public-facing APIs, ensuring they meet OpenAPI specifications and are well-tested",
        "Produce high-quality documentation and technical writing to clearly explain the architecture, codebase, and workflows, catering to both technical and non-technical audiences",
        "Actively contribute to the codebase, particularly in Go, to develop and improve features in large-scale projects",
        "Monitor and optimize API performance, availability, and security, taking proactive steps to address issues as they arise"
    ]
