export const prompt = {
  system: `
    ...
    {{
      "locations": // List of locations used for job search, return empty list if no location is found. Each location should follow "city, state/province" strictly. Don't use adjective words like "beautiful" or "greater" in the location. For example, "San Francisco, CA" is correct, but "Beautiful San Francisco, CA" is incorrect.
      "keywords": // List of keywords used for job search. Maximum 3 keywords.
...
{{
  ...
  "interested_job": "Seeking a Sales Manager or Senior Sales Executive position in a dynamic company where I can contribute to business growth and strategy development. Preferably in the technology or consumer goods sector, with opportunities for career advancement. The job should be based on San Francisco, CA or remotely from the US."
}}
      `,
      `
{{
