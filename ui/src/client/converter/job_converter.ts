// Deprecated for new job crawler

// import { Job, JobDetailsItem } from "../../types/job";

// const parseJobItem = (
//   item: string | null | undefined
// ): JobDetailsItem | undefined => {
//   if (!item) {
//     return undefined;
//   }
...
//       locations: apiJob.match_result.locations?.map((location: string) =>
//         parseJobItem(location)
//       ),
...
//       skills: apiJob.match_result.skills?.map((skill: string) =>
//         parseJobItem(skill)
//       ),
//     },
